# Portfolio Jury Ecole -Gabriel ROULON

Site statique de presentation personnelle destine au jury d'ecole.
Candidature alternance Bachelor Intelligence Artificielle & Business -Eugenia School 2026.

## Acces

https://gab-hub-ctrl.github.io/Mon_Portfolio_Ecole/
...
| `vue_ecole.html` | Hub Vue Jury ecole |
| `profil_personnel.html` | Parcours, competences et objectif professionnel |
| `lettre_motivation_ecole.html` | Lettre de motivation ecole |
| `contact.html` | Coordonnees de contact |
| `presentation_synthetique.html` | Presentation synthetique du projet IT |
